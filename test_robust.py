...
valid_input = pd.DataFrame({
    ...
    'item_count': [2, 1], 'unique_products': [2, 1], 'unique_sellers': [1, 1],
    'total_price': [150.50, 50.00], 'total_freight_value': [25.00, 10.00],
    'payment_count': [1, 1], 'payment_types_count': [1, 1],
    'customer_state': ['SP', 'RJ'], 'customer_city': ['sao paulo', 'rio de janeiro'], 'customer_zip_code_prefix': ['01000', '20000']
})
